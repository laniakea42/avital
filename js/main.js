...
$(function(){
    ...
    $('.open--modal').on('click', function(){
        ...
        $(modal).fadeIn();
        setTimeout(()=> easydropdown.all(), 4000 );
        return false;
    });
    $('.modal .btn-remove, .modal__layer').on('click', function(){
...
$(document).ready(function(){
    ...
    $('#show-cat-icon').on('click', function() {
        $('#h-catalog').toggleClass('opened');
    })
    ...
    if (document.documentElement.clientWidth <= 810) {
        $('.label-c').css({'display': "none"});
        $('.left .cat-title').on('click', function() {
